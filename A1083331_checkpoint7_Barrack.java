...
public class A1083331_checkpoint7_Barrack extends JLabel implements Runnable {
    ...
    public A1083331_checkpoint7_Barrack(int locationX, int locationY, String text, int scaler, int horizontalAlignment) {
