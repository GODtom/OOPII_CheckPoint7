...
public class A1083331_checkpoint7_GamePanel extends JPanel {
    ...
    private int scaler;
    private ArrayList<A1083331_checkpoint7_House> houseList = new ArrayList<A1083331_checkpoint7_House>();
    private ArrayList<A1083331_checkpoint7_Barrack> barrackList = new ArrayList<A1083331_checkpoint7_Barrack>();
    private ArrayList<A1083331_checkpoint7_Pyramid> pyramidList = new ArrayList<A1083331_checkpoint7_Pyramid>();
    private ArrayList<A1083331_checkpoint7_Soldier> soldierList = new ArrayList<A1083331_checkpoint7_Soldier>();
    ...
    public A1083331_checkpoint7_GamePanel(ArrayList<A1083331_checkpoint7_House> houseList, ArrayList<A1083331_checkpoint7_Barrack> barrackList,
            ArrayList<A1083331_checkpoint7_Pyramid> pyramidList,ArrayList<Integer[]> obstacleList, HashMap<Integer, Image> obstacleImg, int scaler) {
    ...
    public void setHouseList(ArrayList<A1083331_checkpoint7_House> houseList) {
        this.houseList = houseList;
    }

    public void setBarrackList(ArrayList<A1083331_checkpoint7_Barrack> barrackList) {
        this.barrackList = barrackList;
    }

    public void setPyramidList(ArrayList<A1083331_checkpoint7_Pyramid> pyramidList) {
        this.pyramidList = pyramidList;
    }

    public void addToSoldierList(A1083331_checkpoint7_Soldier soldier){
        this.soldierList.add(soldier);
    }
    public ArrayList<A1083331_checkpoint7_Soldier> getSoldierList(){
        return soldierList;
    }
