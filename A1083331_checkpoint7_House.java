...
public class A1083331_checkpoint7_House extends JLabel implements Runnable {
    ...
    A1083331_checkpoint7_GameFrame parentFrame;
    ...
    public void run() {
         ...
         ********************************************************************************************/
         ...
         int period=4;
         int second=2000/period;
         int percent=100/period;
         for(int i=0;i<period;i++){
        	String str=String.valueOf(percent*i)+"%";
        	this.setText(str);     	
        	doNothing(second);
     	 }
         this.understructure=false;
    ...
    public A1083331_checkpoint7_House(int locationX, int locationY, String text, int scaler, int horizontalAlignment) {
        ...
        Image constructImg = constructingIcon.getImage();
        constructImg = constructImg.getScaledInstance(originalGridLen / scaler, originalGridLen /scaler, Image.SCALE_DEFAULT);
        constructingIcon.setImage(constructImg);
