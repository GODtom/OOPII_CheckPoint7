...
public class A1083331_checkpoint7_Pyramid extends JLabel implements Runnable {
    ...
    public A1083331_checkpoint7_Pyramid(int locationX, int locationY, String text, int scaler, int horizontalAlignment) {
        ...
        constructImg = constructImg.getScaledInstance(originalGridLen / scaler*2, originalGridLen /scaler*2, Image.SCALE_DEFAULT);
